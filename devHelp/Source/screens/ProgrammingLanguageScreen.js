...
const ProgrammingLanguageScreenActivity=(props)=>{
...
<AuthContext.Consumer>
       ...
       <View style={{flex:1}}>
           ...
           <CategoryCard categoryName={category} dx={"-4"} dy={-13} props={props}>
...
export default ProgrammingLanguageScreenActivity